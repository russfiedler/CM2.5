...
# Due to silliness in stratospher we need to use fp-model-source. May change this just for the rubbish routines?
FFLAGS := -fno-alias -safe-cray-ptr -ftz -assume byterecl -i4 -r8 -traceback -nowarn -check noarg_temp_created -assume nobuffered_io -convert big_endian -grecord-gcc-switches -align all -fp-model-source
